...
**Ready for**: Task(subagent_type="run-prompt", prompt="006 007 008 --sequential")
...
**Execution Command**: Task(subagent_type="run-prompt", prompt="[numbers] --sequential")
...
4. **run-prompt agent** executes prompts sequentially
5. For each prompt:
